package encapsulation_exercises.pizzaCalories_05;
...
public class Dough {
    private static final List<String> FLOUR_TYPES= List.of("White","Wholegrain");  private static final List<String> BACKING_TECHNIQUES = new ArrayList<>() {{
        add("Crispy");
        add("Chewy");
        add("Homemade");
    }};
